  ...
  return (
    <div className="mt-8 p-4 flex flex-col md:flex-row items-center md:items-start gap-8 relative min-h-screen">
      <div className="w-full md:w-1/2 flex justify-center p-0">
        <div className="w-[550] h-[700px] relative">
          <Image
      ...
      <div className="w-full md:w-1/2 py-24">
        <h1 className={`${creepster.className} text-red-700 px-24 text-6xl md:text-8xl mb-4 text-center md:text-left`}>TOPENG JESICA</h1>
        <div className={`${creepster.className} text-white text-2xl md:text-4xl mb-6 max-w-md md:max-w-full md:text-left`}>
          <p className="mb-2">THIS IS A MASK THAT COMES FROM BATAK, WHERE THIS.<br />
            MASK IS A CHINESE IMITATION, THIS MASK CAN ALSO <br />
            CODE.</p>
        </div>
        ...
        <div className={`${creepster.className} text-white px-32 flex flex-col items-center md:items-start mb-8`}>
          <p className="text-3xl md:text-4xl font-bold mb-2 mt-2 px-12 py-3 tracking-wider border border-white rounded-xl">SHOP NOW -RP 370.000,-</p>
        </div>
        <div className="px-32 ">
          <StaticRating rating={3.5} maxStars={5} />
        </div>
      </div>
      <div className={`${creepster.className} fixed bottom-4 left-0 right-0 px-4 py-8 flex justify-between max-w-[1900px] mx-auto`}>
        <a href="/dashboard/product2" className="bg-white text-2xl text-red-700 px-4 py-2 border border-black rounded-xl inline-block">Back</a>
        <a href="/dashboard/product/product3" className="bg-white text-2xl text-[#6A1E55] px-4 py-2 border border-black rounded-xl inline-block">Next</a>
      </div>
    </div>
  );
}